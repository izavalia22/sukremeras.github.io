						...
						<div class="row">
							<div class="product-title col-sm-5 col-md-5">
								...
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><svg viewBox="0 0 12 12"><use xlink:href="#close-delete-small"></use></svg></a>',
							...
							<div class="product-remove col-sm-2 col-md-2">
								<?php
								echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
									'<a href="%s" class="remove" title="%s" data-product_id="%s" data-product_sku="%s"><svg viewBox="0 0 12 12"><use xlink:href="#close-delete-small"></use></svg></a>',
									esc_url( WC()->cart->get_remove_url( $cart_item_key ) ),
									esc_html__( 'Remove this item', 'sober' ),
									esc_attr( $product_id ),
									esc_attr( $_product->get_sku() )
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'sober' ); ?></p>
