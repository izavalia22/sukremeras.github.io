...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-name"><?php esc_html_e( 'Product', 'sober' ); ?></th>
			<th class="product-quantity"><?php esc_html_e( 'Quantity', 'sober' ); ?></th>
			<th class="product-total"><?php esc_html_e( 'Total', 'sober' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'sober' ); ?></th>
			<th></th>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Total', 'sober' ); ?></th>
			<th></th>
