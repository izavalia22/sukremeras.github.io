...
class Soo_Wishlist_Shortcodes {
	...
	public static function wishlist( $atts ) {
		...
		$args = array(
			'list'    => $list,
			'options' => array(
				'show_price'        => get_option( 'soo_wishlist_show_price' ),
				'show_stock_status' => get_option( 'soo_wishlist_show_stock_status' ),
				'show_button'       => get_option( 'soo_wishlist_show_button' ),
			),
		);
