	...
	public static function sharing_template( $list ) {
		...
		$args = array(
			...
			'socials'      => apply_filters( 'soo_wishlist_sharing_socials', array(
				'facebook' => get_option( 'soo_wishlist_share_facebook' ),
				'google'   => get_option( 'soo_wishlist_share_google' ),
				'twitter'  => get_option( 'soo_wishlist_share_twitter' ),
				'email'    => get_option( 'soo_wishlist_share_email' ),
			) ),
		);
